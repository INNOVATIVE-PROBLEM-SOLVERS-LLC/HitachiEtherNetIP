...
namespace Modbus_DLL {
   ...
   public class Data {
      ...
      static public Dictionary<string, int> UTFHToHitachi;

      string[] GreekCharacterSet = new string[] {
      ...
      int[] HitachiGreekCharacters = new int[] {
         0xF2AC, 0xF3C0, 0xF3C1, 0xF3C2, 0xF3C3, 0xF3C4, 0xF3C5, 0xF3C6, 0xF3C7, 0xF3C8, 0xF3C9, 0xF3CA, 0xF3CB, 0xF3CC, 0xF3CD, 0xF3CE,
         0xF3CF, 0xF3D0, 0xF3D1, 0xF3D2, 0xF3D3, 0xF3D4, 0xF3D5, 0xF3D6,
         0xF3DF, 0xF3E0, 0xF3E1, 0xF3E2, 0xF3E3, 0xF3E4, 0xF3E5, 0xF3E6, 0xF3E7, 0xF3E8, 0xF3E9, 0xF3EA, 0xF3EB, 0xF3EC, 0xF3ED, 0xF3EE,
         0xF3EF, 0xF3F0, 0xF3F1, 0xF3F2, 0xF3F3, 0xF3F4, 0xF3F5, 0xF3F6};

      string[] RussianCharacterSet = new string[] {
      ...
      int[] RussianCharacters = new int[] {
         ...
         0x042F, 0x0402, 0x0408, 0x0409, 0x040A, 0x040B, 0x040F,
         ...
         0x044F, 0x0452, 0x0458, 0x0459, 0x045A, 0x045B, 0x045F};

      int[] HitachiRussianCharacters = new int[] {
         ...
         0xF570, 0xF571, 0xF572, 0xF573, 0xF574, 0xF575, 0xF576, 0xF577, 0xF578, 0xF579, 0xF57A, 0xF57B, 0xF57C, 0xF57D, 0xF57E, 0xF580,
         0xF581, 0xF582, 0xF583, 0xF584, 0xF585, 0xF586, 0xF587, 0xF588, 0xF589, 0xF58A, 0xF58B, 0xF58C, 0xF58D, 0xF58E, 0xF58F, 0xF590,
         0xF591, 0xF592, 0xF593, 0xF594, 0xF595, 0xF596, 0xF597};

      string[] DateTimeCharacters = new string[] {
         "{'}",  "{.}",  "{:}",  "{,}",  "{ }",  "{;}",  "{!}",
      ...
      int[] HitachiDateTimeCharacters = new int[] { // 0xF257, 0xF267, 0xF277 are no longer used (Old Month Name)
         0xF240, 0xF241, 0xF242, 0xF243, 0xF244, 0xF245, 0xF246,
         0xF250, 0xF251, 0xF252, 0xF253, 0xF254, 0xF255, 0xF256, 0xF258, 0xF259, 0xF25A, 0xF25B, 0xF25C,
         0xF260, 0xF261, 0xF262, 0xF263, 0xF264, 0xF265, 0xF266, 0xF268, 0xF269, 0xF26A, 0xF26B, 0xF26C,
         0xF270, 0xF271, 0xF272, 0xF273, 0xF274, 0xF275, 0xF276, 0xF278, 0xF279, 0xF27A, 0xF27B, 0xF27C,
      };
      ...
      public Data() {
         ...
         UTFHToHitachi = new Dictionary<string, int>();

         for (int i = 0; i < GreekCharacterSet.Length; i++) {
            UTFHToHitachi.Add(GreekCharacterSet[i], HitachiGreekCharacters[i]);
            HitachiToUTF8.Add(HitachiGreekCharacters[i], GreekCharacterSet[i]);
         }

         for (int i = 0; i < RussianCharacterSet.Length; i++) {
            UTFHToHitachi.Add(RussianCharacterSet[i], HitachiRussianCharacters[i]);
            HitachiToUTF8.Add(HitachiRussianCharacters[i], RussianCharacterSet[i]);
         }

         for (int i = 0; i < DateTimeCharacters.Length; i++) {
            UTFHToHitachi.Add(DateTimeCharacters[i], HitachiDateTimeCharacters[i]);
      ...
      private AttrData[] ccSR_Addrs = new AttrData[] {
         ...
         new AttrData((int)ccSR.Hour, true, 24, 2, 0,                           // Hour 0x1B75
      ...
      private AttrData[] ccUS_Addrs = new AttrData[] {
         ...
         new AttrData((int)ccUS.Operation_Status, false, 1, 0,                  // Operation Status 0x0002
            new Prop(1, DataFormats.Decimal, 0x30, 0x72, fmtDD.OperationStatus)), //   Data
